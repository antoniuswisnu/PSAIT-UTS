            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="mt-5 mb-3 clearfix">
                        <h2 class="pull-left">Student Score Data</h2>
                        <a href="insertNilaiView.php" class="btn btn-success pull-right"><i class="fa fa-plus"></i> Add New Score</a>
                    </div>
                    <div class="scroll">
                    <?php
                        $curl= curl_init();
                        ...
                        curl_setopt($curl, CURLOPT_URL, 'localhost/sait_uts_api/nilai_api.php');
                        $res = curl_exec($curl);
                                ...
                                echo '<table class="table table-bordered table-striped">';
                                    ...
                                    for ($i = 0; $i < count($json["data"]); $i++){
                                        echo "<tr>";
                                            ...
                                            echo "<td>";
                                                echo '<a href="updateNilaiView.php?nim='.$json["data"][$i]["nim"].'&kode_mk='.$json["data"][$i]["kode_mk"].'" class="mr-3" title="Update Record" data-toggle="tooltip">
